...
- **Harmonic Relay: Gridfall** — choose your own line through five simultaneous city faults, arrive at each above its speed gate, then hold Focus to tune it before the grid clock expires.
...
- [x] Layered Focus simulation, Speed Sense target marking and map route sequencing
- [x] Harmonic Relay: Gridfall traversal emergency with persistent records and an assist mode
